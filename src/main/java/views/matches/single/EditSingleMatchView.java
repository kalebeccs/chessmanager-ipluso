...
public class EditSingleMatchView extends BaseView {
    ...
    public EditSingleMatchView(JPanel mainPanel, CardLayout cardLayout, SingleMatchController singleMatchController,
        ...
        players.forEach(player -> cbPlayer1.addItem(player.getName()));

        JLabel lblPlayer2 = new JLabel("Player 2:");
        cbPlayer2 = new JComboBox<>();
        cbPlayer2.addItem("Select Player 2");
        players.forEach(player -> cbPlayer2.addItem(player.getName()));
    ...
    private void loadMatch() {
        try {
            ...
            SingleMatch match = singleMatchController.getMatchById(matchId);
            if (match != null) {
                cbPlayer1.setSelectedItem(match.getPlayer1().getName());
                cbPlayer2.setSelectedItem(match.getPlayer2().getName());
                ...
                cbType.setSelectedItem(match.getType());
            } else {
    ...
    private void saveMatch() {
        ...
        try {
            int matchId = Integer.parseInt(txtMatchId.getText());
            SingleMatch match = new SingleMatch(player1, player2, arbiter, moves, time, winner, type,
                    result);
            singleMatchController.updateMatch(matchId, match);
